...
<html lang="en">
<head>
    <title>Code coverage report for api-build/commands/update.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">api-build/commands</a> update.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports.usage = `Update the used version of this service
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (e.error.code === 'TeamSelectionRequired') {</span>
<span class="cstat-no" title="statement not covered" >      enquirer.ask([{</span>
      ...
      }]).then(<span class="fstat-no" title="function not covered" >re</span>sults =&gt; <span class="cstat-no" title="statement not covered" >module.exports.run(args, results))</span>;
    }
  });
};
&nbsp;
