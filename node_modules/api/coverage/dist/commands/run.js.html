...
<html lang="en">
<head>
    <title>Code coverage report for dist/commands/run.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dist/commands</a> run.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    return invoke(team.key, service, action, data, true).then(response =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Buffer.isBuffer(response.file)) {
<span class="cstat-no" title="statement not covered" >        process.stdout.write(response.file);</span>
      } else {
