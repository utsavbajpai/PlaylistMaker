...
<html lang="en">
<head>
    <title>Code coverage report for dist/commands/unlink.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dist/commands</a> unlink.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports.usage = `Remove linked services
&nbsp;
Usage:
...
module.exports.run = args =&gt; {
  ...
  const links = utils.fileExists(linksPath) ? require(linksPath) : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
&nbsp;
  ...
  fs.writeFile(linksPath, JSON.stringify(links), err =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >console.error(err);</span>
  });
};</pre></td></tr>
</table></pre>
