...
<html lang="en">
<head>
    <title>Code coverage report for dist/commands/help.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dist/commands</a> help.js
    </h1>
    <div class='clearfix'>
...
function getAliases(file) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!file.match(/.js$/)) <span class="cstat-no" title="statement not covered" >return undefined;</span>
