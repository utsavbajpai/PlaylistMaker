...
<html lang="en">
<head>
    <title>Code coverage report for src/commands/link.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/commands</a> link.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      console.error(err);</span>
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (links.services[args[1]]) { // check we know about service trying to be linked
