...
<html lang="en">
<head>
    <title>Code coverage report for dist/lib/package-json.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dist/lib</a> package-json.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">67x</span></td><td class="text"><pre class="prettyprint lang-js">const fs = require('fs');
...
&nbsp;
module.exports = (...args) =&gt; new PackageJson(...args);</pre></td></tr>
</table></pre>
