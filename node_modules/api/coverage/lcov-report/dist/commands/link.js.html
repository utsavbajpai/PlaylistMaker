...
<html lang="en">
<head>
    <title>Code coverage report for dist/commands/link.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dist/commands</a> link.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* Link file format:
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      console.error(err);</span>
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (links.services[args[1]]) {
    // check we know about service trying to be linked
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!links.directories[process.cwd()]) {
...
<span class="cstat-no" title="statement not covered" >    console.log(`You need to run ${'`api link`'.green} in your service directory first!`); </span>// TODO: come up with better message
  }
};</pre></td></tr>
</table></pre>
