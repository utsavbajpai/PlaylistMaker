...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/file-utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> file-utils.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const fileType = require('file-type');
const Stream = require('stream');
const request = require('request-promise');
const fs = require('fs');
const { URL } = require('url');
&nbsp;
exports.file = <span class="fstat-no" title="function not covered" >(p</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >  if (exports.isUrl(p)) {</span>
<span class="cstat-no" title="statement not covered" >    return request.get({ url: p, encoding: null });</span>
  }
<span class="cstat-no" title="statement not covered" >  return fs.createReadStream(p);</span>
};
&nbsp;
exports.isUrl = (s) =&gt; {
  try {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jan 12 2018 11:24:08 GMT-0800 (PST)
</div>
</div>
